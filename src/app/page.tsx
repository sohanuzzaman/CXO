  ...
  return (
    <>
      ...
      <section className="bg-[#0a4e65] text-white py-16 sm:py-20 lg:py-24">
        <div className="container mx-auto px-4 max-w-7xl flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-[47%]">
            <Image 
              src="/img/lead.png" 
              className="rounded-[35px] sm:rounded-[45px] lg:rounded-[55px] shadow-lg w-full" 
              alt="Leadership" 
              width={600} 
              height={400}
            />
          ...
          <div className="w-full lg:w-[53%] lg:pl-8 xl:pl-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-light leading-tight mb-6 lg:mb-10">
              ...
              <span className="italic text-yellow-400"> Customer Experience</span>
            </h2>
            <ul className="space-y-3 sm:space-y-4 text-lg sm:text-xl font-light list-disc ml-5 leading-relaxed">
              <li>Actionable insights from top CX leaders</li>
              <li>A trusted peer network of CCOs and CXOs</li>
              <li>Curated sessions on strategy, innovation, and leadership</li>
              <li>Exclusive access to virtual and in-person roundtables</li>
              <li>Benchmarking and data sharing to guide smarter decisions</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#efe6dc] pb-16 sm:pb-20 z-[2]">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden z-[2] -translate-y-8 sm:-translate-y-10">
            <div className="flex flex-col md:flex-row justify-between items-stretch p-6 sm:p-8 lg:p-12 gap-6 lg:gap-8">
              <div className="w-full md:w-1/2 pr-0 md:pr-8 md:border-r md:border-r-[#b7b7b7] flex flex-col justify-center">
                <h3 className="text-3xl sm:text-4xl md:text-5xl xl:text-6xl italic font-serif mb-4 sm:mb-6 text-black">
                  Who It&apos;s For
                </h3>
                <p className="text-black text-lg sm:text-xl lg:text-2xl xl:text-3xl font-light leading-relaxed">
              ...
              <div className="w-full md:w-1/2 text-lg font-light text-gray-800 flex flex-col justify-center">
                <ul className="ml-0 lg:ml-8 space-y-4 sm:space-y-6">
                  <li>
                    <strong className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold">• CXO</strong><br />
                    <span className="italic text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium ml-2 sm:ml-4 lg:ml-6 xl:ml-8">
                      Chief Experience Officer
                    </span>
                  </li>
                  <li>
                    <strong className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold">• CCO</strong><br />
                    <span className="italic text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium ml-2 sm:ml-4 lg:ml-6 xl:ml-8">
            ...
            <div className="bg-black text-white text-center py-4 sm:py-6 text-lg sm:text-xl lg:text-2xl xl:text-3xl italic font-light rounded-b-2xl px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12 max-w-6xl mx-auto">
              ...
              <div className="flex flex-col items-center text-center">
                <div className="w-20 h-20 sm:w-24 sm:h-24 mb-4 sm:mb-6">
                  <svg className="w-full h-full" id="bold" enableBackground="new 0 0 24 24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-black mb-2 font-basic">Peer Sessions</h3>
                <p className="text-sm sm:text-base text-gray-700 italic leading-relaxed">Monthly confidential forums</p>
              </div>

              {/* Executive Roundtables */}
              <div className="flex flex-col items-center text-center">
                <div className="w-20 h-20 sm:w-24 sm:h-24 mb-4 sm:mb-6">
                  <svg className="w-full h-full" viewBox="0 0 512.001 512" xmlns="http://www.w3.org/2000/svg">
                ...
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-black mb-2 font-basic">Executive Roundtables</h3>
                <p className="text-sm sm:text-base text-gray-700 italic leading-relaxed">Intimate CX leader discussions</p>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-black mb-2 font-basic">Insights & Resources</h3>
                <p className="text-sm sm:text-base text-gray-700 italic leading-relaxed">Playbooks and benchmarks</p>
              </div>

              {/* Private Community */}
              <div className="flex flex-col items-center text-center">
                <div className="w-20 h-20 sm:w-24 sm:h-24 mb-4 sm:mb-6">
                  <svg className="w-full h-full" id="Capa_1" enableBackground="new 0 0 587.773 587.773" viewBox="0 0 587.773 587.773" xmlns="http://www.w3.org/2000/svg">
                    <g>
                      <g id="Page-1_37_">
                ...
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-black mb-2 font-basic">Private Community</h3>
                <p className="text-sm sm:text-base text-gray-700 italic leading-relaxed">Trusted space to connect and grow</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-10 lg:gap-12">
            ...
            <div className="flex flex-col items-center text-center">
              <Image 
                src="/img/suzie.png" 
                alt="Suzie Dieth" 
                className="w-48 h-48 sm:w-56 sm:h-56 lg:w-60 lg:h-60 rounded-2xl sm:rounded-3xl border border-yellow-200 object-cover mb-4 sm:mb-6" 
                width={240} 
                height={240} 
              />
              <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white mb-2 sm:mb-3">Suzie Dieth</h3>
            ...
            <div className="flex flex-col items-center text-center">
              <Image 
                ...
                height={240} 
              />
              <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white mb-2 sm:mb-3">Jeff Gelfuso</h3>
              <p className="text-sm sm:text-base text-gray-300 leading-relaxed max-w-xs mx-auto">
            ...
            <div className="flex flex-col items-center text-center">
              <Image 
                ...
                height={240} 
              />
              <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white mb-2 sm:mb-3">Valarie Vest</h3>
              <p className="text-sm sm:text-base text-gray-300 leading-relaxed max-w-xs mx-auto">
      ...
      >
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10">
          ...
          <div className="w-full md:w-[90%] lg:w-[86%] text-center lg:text-left">
            <h4 className="italic text-2xl sm:text-3xl lg:text-4xl xl:text-5xl text-white mb-2">About</h4>
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-8xl font-extrabold mb-6 sm:mb-8 lg:mb-10">Blake Morgan</h2>
            <div className="max-w-none lg:max-w-[600px]">
              <p className="mb-4 sm:mb-6 text-base sm:text-lg md:text-xl leading-relaxed text-white">
      ...
      {/* Final CTA Section */}
      <section className="bg-[#efe6dc] py-16 sm:py-20 lg:py-24 text-center bg-cover bg-center px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-light italic mb-4 sm:mb-6 text-black leading-tight">Join the Network of Experience Leaders</h2>

    ...
    <main className="fade-in">
          ...
          <div className="relative z-10 max-w-4xl px-4 sm:px-6 py-8 md:py-12 lg:py-16 text-left hero-mobile-spacing">
            ...
            <div>
              <button
                ...
                className="inline-block bg-[#ffaf02] hover:bg-[#e9a104] text-black font-bold px-8 md:px-8 py-4 md:py-4 rounded-full transition-all duration-300 mt-2 md:mt-4 text-xl sm:text-lg md:text-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 hover:scale-105 active:scale-95 focus-ring interactive-element group cursor-pointer border-0 mobile-cta-button"
      ...
      <section className="bg-[#0a4e65] text-white py-16 sm:py-20 lg:py-24">
        <div className="container mx-auto px-4 max-w-7xl flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-[53%] lg:pl-8 xl:pl-12">
            <h2 className="text-3xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-light leading-tight mb-6 lg:mb-10">
              Lead from the Front Line of
              <span className="italic text-yellow-400 transition-colors duration-300 hover:text-yellow-300">
                {" "}
                Customer Experience
              </span>
            </h2>
            <ul className="space-y-3 sm:space-y-4 text-xl sm:text-lg md:text-xl font-light list-disc ml-5 leading-relaxed">
              <li className="hover:text-yellow-200 transition-colors">
                Actionable insights from top CX leaders
              </li>
              <li className="hover:text-yellow-200 transition-colors">
                A trusted peer network of CCOs and CXOs
              </li>
              <li className="hover:text-yellow-200 transition-colors">
                Curated sessions on strategy, innovation, and leadership
              </li>
              <li className="hover:text-yellow-200 transition-colors">
                Exclusive access to virtual and in-person roundtables
              </li>
              <li className="hover:text-yellow-200 transition-colors">
                Benchmarking and data sharing to guide smarter decisions
              </li>
            </ul>
          </div>
        </div>
      ...
      <section className="bg-[#efe6dc] pb-16 sm:pb-20 z-[2]">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden z-[2] -translate-y-8 sm:-translate-y-10 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-12 group">
            <div className="flex flex-col md:flex-row justify-between items-stretch p-6 sm:p-8 lg:p-12 gap-6 lg:gap-8">
              <div className="w-full md:w-1/2 pr-0 md:pr-8 md:border-r md:border-r-[#b7b7b7] flex flex-col justify-center">
                <h3 className="text-4xl sm:text-4xl md:text-5xl xl:text-6xl italic font-serif mb-4 sm:mb-6 text-black group-hover:text-[#0db8ff] transition-colors duration-500">
                  Who It&apos;s For
                </h3>
                <p className="text-black text-xl sm:text-xl lg:text-2xl xl:text-3xl font-light leading-relaxed group-hover:text-gray-700 transition-colors duration-500">
                  Our members are C-level executives leading customer, digital,
                  and experience strategy across industries:
                </p>
              </div>
              <div className="w-full md:w-1/2 text-lg font-light text-gray-800 flex flex-col justify-center">
                <ul className="ml-0 lg:ml-8 space-y-4 sm:space-y-6">
                  <li className="group/item hover:scale-105 transition-transform duration-300">
                    <strong className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold group-hover/item:text-[#ffaf02] transition-colors duration-300">
                      • CXO
                    </strong>
                    <br />
            ...
            <div className="bg-black text-white text-center py-4 sm:py-6 text-lg sm:text-xl lg:text-2xl xl:text-3xl italic font-light rounded-b-2xl px-4 group-hover:bg-[#0a4e65] transition-colors duration-500">
              <p>
                Industries: Retail, Financial Services, Healthcare, Travel,
                Energy, Media
              </p>
            </div>
          </div>
          ...
          <div className="text-center mt-12 sm:mt-16 lg:mt-20">
            <h2 className="text-4xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-serif italic text-black mb-12 sm:mb-16">
              Programs and Benefits
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12 max-w-6xl mx-auto">
              ...
              <div className="flex flex-col items-center text-center group hover:scale-105 transition-all duration-300">
                <div className="w-20 h-20 sm:w-24 sm:h-24 mb-4 sm:mb-6 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3">
                  <svg
                    className="w-full h-full group-hover:text-[#0db8ff] transition-colors duration-300"
                    id="bold"
                ...
                <h3 className="text-xl sm:text-xl lg:text-2xl font-bold text-black mb-2 font-basic group-hover:text-[#0db8ff] transition-colors duration-300">
                  Peer Sessions
                </h3>
                <p className="text-base sm:text-base text-gray-700 italic leading-relaxed group-hover:text-gray-900 transition-colors duration-300">
                  Monthly confidential forums
                </p>
              </div>
              ...
              <div className="flex flex-col items-center text-center group hover:scale-105 transition-all duration-300">
                ...
                <p className="text-base sm:text-base text-gray-700 italic leading-relaxed group-hover:text-gray-900 transition-colors duration-300">
                  Intimate CX leader discussions
                </p>
              </div>
              ...
              <div className="flex flex-col items-center text-center group hover:scale-105 transition-all duration-300">
                <div className="w-20 h-20 sm:w-24 sm:h-24 mb-4 sm:mb-6 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3">
                  <svg
                    className="w-full h-full group-hover:text-[#0db8ff] transition-colors duration-300"
                    id="Capa_1"
                    enableBackground="new 0 0 587.773 587.773"
                    viewBox="0 0 587.773 587.773"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <g>
                      <g id="Page-1_37_">
                        <g
                          id="_x30_88---Locked-Network"
                        ...
                        >
                          ...
                          <path
                            id="Shape_316_"
                            d="m273.966 346.519h41.948c5.792 0 10.487-4.695 10.487-10.487v-41.948c0-5.792-4.695-10.487-10.487-10.487h-41.948c-5.792 0-10.487 4.695-10.487 10.487v41.948c0 5.792 4.695 10.487 10.487 10.487zm20.974-41.948c5.792 0 10.487 4.695 10.487 10.487s-4.695 10.487-10.487 10.487-10.487-4.695-10.487-10.487 4.695-10.487 10.487-10.487z"
                          />
                          <circle
                            id="Oval_26_"
                            cx="127.148"
                ...
                <p className="text-base sm:text-base text-gray-700 italic leading-relaxed group-hover:text-gray-900 transition-colors duration-300">
                  Trusted space to connect and grow
                </p>
              </div>
            </div>
            <div className="mt-10 sm:mt-12 lg:mt-16 animate-in fade-in-50 slide-in-from-bottom delay-[1500ms]">
              <button
                onClick={() => setIsModalOpen(true)}
                className="inline-block bg-[#ffaf02] hover:bg-[#e9a104] text-black font-bold px-8 sm:px-10 lg:px-12 py-3 sm:py-4 rounded-full transition-all duration-300 text-xl sm:text-xl lg:text-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 hover:scale-105 active:scale-95 focus-ring interactive-element group cursor-pointer border-0"
      ...
      >
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10">
          ...
          <div className="w-full md:w-[90%] lg:w-[86%] text-center lg:text-left">
            <h4 className="italic text-3xl sm:text-3xl lg:text-4xl xl:text-5xl text-white mb-2 animate-in fade-in-50 slide-in-from-left duration-1000 delay-600">
              About
            </h4>
            <h2
              className="text-4xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-8xl font-extrabold mb-6 sm:mb-8 lg:mb-10 animate-in fade-in-50 slide-in-from-left duration-1000 delay-800 hover:text-yellow-400 transition-colors italic font-normal"
              style={{
                fontFamily: "'Brush Script MT', 'Lucida Handwriting', cursive",
              }}
            >
            ...
            <div className="max-w-none lg:max-w-[600px] animate-in fade-in-50 slide-in-from-bottom duration-1000 delay-1000">
              <p className="mb-4 sm:mb-6 text-lg sm:text-lg md:text-xl leading-relaxed text-white hover:text-gray-200 transition-colors duration-300">
                Blake Morgan was called &quot;The Queen of CX&quot; by Meta. She
                is a customer experience futurist and author of three books on
                customer experience. Her new book is called The 8 Laws of
                Customer-Focused Leadership: The New Rules for Building A
                Business Around Today&apos;s Customer. Blake has taught courses
                at Columbia University, Rutgers Executive MBA program, and UC
                San Diego. She is an instructor for LinkedIn Learning.
              </p>
              <p className="text-white text-base sm:text-lg md:text-xl leading-relaxed hover:text-gray-200 transition-colors duration-300">
                Blake is the host of The Modern Customer Podcast. She lives in
                the Los Angeles Area with her husband, their two children and
                two dogs.
              </p>
            </div>
          </div>
      ...
      <section className="bg-[#efe6dc] py-16 sm:py-20 lg:py-24 text-center bg-cover bg-center px-4 animate-in slide-in-from-bottom duration-1000 delay-500">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-light italic mb-4 sm:mb-6 text-black leading-tight animate-in fade-in-50 slide-in-from-bottom duration-1000 delay-700">
            Join the Network of Experience Leaders
          </h2>
          <p className="text-black mb-6 sm:mb-8 lg:mb-10 mx-auto max-w-[600px] text-base sm:text-lg lg:text-xl leading-relaxed animate-in fade-in-50 slide-in-from-bottom duration-1000 delay-900">
            Apply now to access the conversations, insights, and relationships
        ...
        <div className="p-8 bg-gradient-to-br from-white to-gray-50">
          ...
          >
            ...
            <input
              ...
              value="y+b+i6sFK+T/nLegqEajm95HziriPDSJwJksKCg+ijOFsE4TNox0+JdBkFvckyPisf//z5aZX1cLsHZByTp3hw=="
            />

            <div className="space-y-5">
              <div className="group">
                <label
                  htmlFor="form_submission_name"
                  className="block text-sm font-medium text-[#0a4e65] mb-3 tracking-wide"
                >
                  Full Name *
                </label>
                <input
              ...
              <div className="group">
                <label
                  htmlFor="form_submission_custom_10"
                  className="block text-sm font-medium text-[#0a4e65] mb-3 tracking-wide"
                >
                  Organization *
                </label>
              ...
              <div className="group">
                <label
                  htmlFor="form_submission_custom_11"
                  className="block text-sm font-medium text-[#0a4e65] mb-3 tracking-wide"
                >
                  Title
                </label>
            ...
            <p className="text-xs text-gray-500 text-center leading-relaxed">
              By submitting this form, you agree to be contacted about CXO House
